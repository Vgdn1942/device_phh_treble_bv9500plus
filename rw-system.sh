...
if getprop ro.vendor.build.fingerprint | grep -iq -e Blackview/BV9500Plus; then
    for f in /vendor/ueventd.rc /vendor/bin/hw/android.hardware.light@2.0-service-mediatek \
        ...
        a="$(echo "$f" | tr / _)"
        b="$(echo "$f" | rev | cut -d'/' -f1 | rev)" # basename
        ...
        case "$b" in
          "ueventd.rc" )
            ...
            echo "" >> "/mnt/phh/$a"
            ;;
          "android.hardware.light@2.0-service-mediatek" | "android.hardware.light@2.0-service-mediatek.rc")
            cp "system/phh/$b" "/mnt/phh/$a"
            ;;
        esac
    ...
    # TODO Add check mount new libs
    #mount -o bind /system/phh/empty /vendor/lib/hw/android.hardware.light@2.0-impl-mediatek.so
    #mount -o bind /system/phh/empty /vendor/lib64/hw/android.hardware.light@2.0-impl-mediatek.so
    #mount -o bind /system/phh/empty /vendor/lib/hw/lights.mt6771.so
    #mount -o bind /system/phh/empty /vendor/lib64/hw/lights.mt6771.so
fi
